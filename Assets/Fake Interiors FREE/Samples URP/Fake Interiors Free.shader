	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				output.ase_texcoord8.xyz = vertexToFrag143_g2;
						 ...
						 ) : SV_Target
			{
				...
				float3 vertexToFrag143_g2 = input.ase_texcoord8.xyz;
				...
				float2 uv_FacadeAlbedo = input.ase_texcoord9.xy * _FacadeAlbedo_ST.xy + _FacadeAlbedo_ST.zw;
